...
void drawScene(){
  ...
  for (i = 0; i < node_quantity; i++) {
    ...
    glVertex3f(nodes[i].start.x / (50000 * LY), nodes[i].start.y / (50000 * LY),
        nodes[i].start.z / (50000 * LY));
    glVertex3f(nodes[i].start.x / (50000 * LY), nodes[i].end.y / (50000 * LY),
        nodes[i].start.z / (50000 * LY));
    glVertex3f(nodes[i].end.x / (50000 * LY), nodes[i].end.y / (50000 * LY),
        nodes[i].start.z / (50000 * LY));
    glVertex3f(nodes[i].end.x / (50000 * LY), nodes[i].start.y / (50000 * LY),
        nodes[i].start.z / (50000 * LY));
    glVertex3f(nodes[i].start.x / (50000 * LY),
        nodes[i].start.y / (50000 * LY), nodes[i].start.z / (50000 * LY));
    glVertex3f(nodes[i].start.x / (50000 * LY),
        nodes[i].start.y / (50000 * LY), nodes[i].end.z / (50000 * LY));
    glVertex3f(nodes[i].start.x / (50000 * LY), nodes[i].end.y / (50000 * LY),
